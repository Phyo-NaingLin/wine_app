                      ...
                      Container(
                          ...
                          child: ListView(
                              ...
                              children: wineBrands.map((wine) {
                                return _buildCard(wine, context);
                                // return Text(wine.title.toString());
                              }).toList()))
                    ],
                  ),
                ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Text('Recommend',
                    style:
                        TextStyle(fontFamily: 'AbrilFatFace', fontSize: 25.0)),
                Text('More',
...
Widget _buildCard(Wine wine, BuildContext context) {
  return Padding(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
                ...
                right: 10.0,
                child:
                    Icon(Icons.shopping_cart, color: Colors.white, size: 15.0)),
            Positioned(
                top: 175.0,
                left: 10.0,
                child: Column(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text(wine.rating!.roundToDouble().toString(),
                            style: TextStyle(
                                fontSize: 14.0, color: Color(0xFF199693))),
                      ],
                    )
                  ],
                ))
