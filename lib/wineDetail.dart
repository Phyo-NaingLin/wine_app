            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('Pair with: Fried Chicken, Ramen Noodles, Nacho Supreme',
                      style: TextStyle(fontSize: 12.0, color: Colors.grey)),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  child: Text(
                      'Whether it\'s an impromtu gathering with good friends or sustainbly canning wine to keep up with your daily adventures.Together we seek the uncommon',
                      style: TextStyle(fontSize: 12.0, color: Colors.grey)),
                ),
              ],
            ),
